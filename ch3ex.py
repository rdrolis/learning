...
print(f"\n{guest[0].title()} you are invited to dinner at my house tomorrow \
evening.")
print(f"{guest[1].title()} you are invited to dinner at my house tomorrow \
evening.")
print(f"{guest[2].title()} you are invited to dinner at my house tomorrow \
evening.")
...
print(f"{guest[2].title()} you are invited to dinner at my house tomorrow \
evening.")
print(f"{guest[3].title()} you are invited to dinner at my house tomorrow \
evening.")
print(f"{guest[4].title()} you are invited to dinner at my house tomorrow \
evening.")
print(f"{guest[5].title()} you are invited to dinner at my house tomorrow \
evening.")
# Exercise 3-7 Shrinking guest list
guest_notify = guest.pop(0)
print(f"\n{guest_notify.title()}, I am terribly sorry. I will have to cancel \
      the invitation sent earlier.")
guest_notify = guest.pop(0)
print(f"{guest_notify.title()}, I am terribly sorry. I will have to cancel \
      the invitation sent earlier.")
...
print(f"\n{guest_notify.title()} our dinner plans for tomorrow have been \
      finalized")
guest_notify = guest[1]
print(f"{guest_notify.title()} our dinner plans for tomorrow have been \
      finalized")
del guest[0]
del guest[0]
print(guest)
